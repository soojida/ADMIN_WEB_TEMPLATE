...
// 유틸리티
import { getBackgroundStyle } from "@/utils/components/tooltip/getBackgroundStyle";
import { getDirectionStyle } from "@/utils/components/tooltip/getDirectionStyle";
import { getShapeStyle } from "@/utils/components/tooltip/getShapeStyle";
...
const TooltipMessage = styled.div<TooltipProps>`
  ...
  height: auto;
  width: ${({ width }) => (width === "" ? "max-content" : width)};
