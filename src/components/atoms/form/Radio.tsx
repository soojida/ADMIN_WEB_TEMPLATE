...
const RadioForm = styled.div`
  ...
  input[type="radio"] {
    ...
    &:checked {
      border: none;
      background: url("data:image/svg+xml,%3Csvg stroke='%23212224' fill='%23212224' stroke-width='0' viewBox='0 0 24 24' height='22px' width='22px' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath fill='none' d='M0 0h24v24H0V0z'%3E%3C/path%3E%3Cpath d='M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8z'%3E%3C/path%3E%3Ccircle cx='12' cy='12' r='5'%3E%3C/circle%3E%3C/svg%3E")
